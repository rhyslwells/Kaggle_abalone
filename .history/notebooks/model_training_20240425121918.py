...
# Notice that in cross-validation, we first split the dataset and then add the original data only to the training dataset. 
# The validation dataset consists purely of competition data.
