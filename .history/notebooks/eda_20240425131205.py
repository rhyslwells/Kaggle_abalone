...
# A log transformation is a powerful tool to handle skewed data. It can help to normalize the data and make it more suitable for a machine learning model.
# This transformation involves taking the logarithm of each data point (y = log(x)).
...
#show a histogram of log_Volume
plt.figure(figsize=(6, 4))
...
train[["Volume","log_Volume"]].head(3)
